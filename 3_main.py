...
os.system("libcamera-jpeg -o ./demoImage/capture.jpg --width 640 --height 480")     #5초 이후에 사진이 찍힌다.
# os.system("libcamera-jpeg -o ./demoImage/capture.jpg -t 10000 --width 640 --height 480")      #10초 이후에 사진이 찍힌다.
